...
@DisplayName("PixTransferNotFoundException - Testes Unitários")
class PixTransferNotFoundExceptionTest {
    ...
    void dado_excecao_criada_quando_obter_mensagem_entao_deve_retornar_mensagem_correta() {
        ...
        PixTransferNotFoundException exception = new PixTransferNotFoundException();
        ...
        assertThat(message).isEqualTo("Transferência PIX não encontrada.");
    }
    ...
    void dado_excecao_criada_quando_obter_codigo_erro_entao_deve_retornar_codigo_correto() {
        ...
        assertThat(errorCode).isEqualTo("PIX_TRANSFER_NOT_FOUND");
    }
