...
class PixControllerTest {
    ...
    @Nested
    @DisplayName("Cenários de Transferência PIX")
    class TransferPixScenarios {
        ...
        void dado_requisicao_quando_chamar_endpoint_entao_deve_chamar_servico_com_parametros_corretos() {
            ...
            // Then - Então deve chamar o serviço com a chave de idempotência e a requisição corretas
    ...
    @Nested
    @DisplayName("Cenários de Webhook PIX")
    class WebhookScenarios {
